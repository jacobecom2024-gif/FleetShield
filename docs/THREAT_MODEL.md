...
|---|---|---|
| At-least-once delivery | Pub/Sub redelivers an invoice | Business idempotency invariant |
...
| Scope error | Refund policy applied to credential rotation | Explicit side-effect class and shadow evaluation |
